...
function Lead({
  ...
  return (
    <div className="max-w-[62ch] space-y-3">
      <p className="text-brand font-mono text-[0.8rem] tracking-wide uppercase">{eyebrow}</p>
  ...
  return (
    <div className="min-h-screen">
        ...
        <div className="mx-auto max-w-[1200px] px-5 py-14 sm:py-20">
          <div className="grid gap-10 lg:grid-cols-[1.35fr_1fr] lg:items-end">
            <div className="space-y-6">
              <h1 className="text-[2.6rem] leading-[1.03] font-semibold tracking-tight text-balance sm:text-[3.6rem]">
                One movement,
                <br />
                <span className="text-brand">written four ways.</span>
              </h1>
              <p className="prose-note max-w-[60ch] text-[1.3rem] leading-relaxed">
                Dance has no single way of being written down. Each system that tried had to decide what really matters:
                where a limb points, how high it is, how long it takes, who moves. Change one thing below and watch all
                four ways of writing rewrite themselves.
              </p>
              <div className="flex flex-wrap items-center gap-4">
                <ModeSwitch mode={mode} onChange={setMode} className="md:hidden" />
                <p className="text-muted-foreground max-w-[48ch] text-[0.95rem] leading-relaxed">
                  Switch <strong className="text-foreground">Body → Numbers</strong> to take the dancer away. Arms and
                  legs become numbered channels, and every direction becomes a pair of angles.
                  <InfoTip title="Why take the body away?" className="ml-1">
                    <p>
                      Strip the picture of a person out of a notation and what is left is a small set of numbers: which
                      part, which direction, how high, how long, how smoothly.
                    </p>
                    <p>
                      That set is what all four systems share. It is also, exactly, what a computer animates — which is
                      why choreography and 3-D animation ended up describing movement the same way.
                    </p>
                  </InfoTip>
                </p>
              </div>
              ...
              >
                ...
                Open the Studio — build your own
              </Link>
            </div>
            ...
            <Card className="gap-0 py-0">
              <CardContent className="divide-y px-0">
                {[
                  { n: "1", t: "Change one thing", d: "Pick a body part, a direction, a height, a length." },
                  { n: "2", t: "Watch four scores", d: "Every tab rewrites that same change in its own language." },
                  { n: "3", t: "Roll the dice", d: "Let chance write the phrase, the way Cunningham did." },
                ].map((s) => (
                  <div key={s.n} className="flex gap-4 p-5">
                    <span className="bg-muted text-muted-foreground flex size-7 shrink-0 items-center justify-center rounded-full font-mono text-[0.8rem]">
                      {s.n}
                    </span>
                    <div className="space-y-1">
                      <p className="font-medium">{s.t}</p>
                      <p className="text-muted-foreground text-[0.95rem] leading-relaxed">{s.d}</p>
                    </div>
                  </div>
                ))}
              </CardContent>
      ...
      <div className="bg-background/85 sticky top-16 z-40 border-b backdrop-blur-md">
        <div className="mx-auto flex max-w-[1200px] flex-wrap items-center gap-3 px-5 py-3">
          ...
          <Tooltip>
            <TooltipTrigger
              render={
                <Button size="lg" variant="outline" onClick={castChance} className="text-destructive gap-2">
          ...
          <div className="flex items-center gap-1">
            <Button variant="ghost" size="icon" aria-label="Previous event" onClick={() => step(-1)}>
              <ChevronLeft className="size-4" />
            </Button>
            <span className="font-mono text-[0.9rem] tabular-nums">
              event {selected + 1}/{phrase.length}
            </span>
            <Button variant="ghost" size="icon" aria-label="Next event" onClick={() => step(1)}>
      ...
      <main className="mx-auto max-w-[1200px] px-5 py-10">
        <Tabs value={tab} onValueChange={(v) => setTab(String(v))} className="gap-8">
          <TabsList className="h-auto w-full flex-wrap justify-start gap-1 p-1.5">
            {TABS.map(({ value, label, Icon }) => (
              <TabsTrigger key={value} value={value} className="h-9 flex-none gap-2 px-3.5 text-[0.95rem]">
          ...
          {/* ---------------------- 1. THE PHRASE ---------------------- */}
          <TabsContent value="phrase" className="space-y-8">
            <Lead
              ...
              info={
                <>
                  <p>
                    LifeForms was built in the 1980s at Simon Fraser University by Tom Calvert&apos;s group, and later
                    sold as <em>DanceForms</em>. Merce Cunningham began composing with it in 1989.
                  </p>
                  <p>
                    He had been using chance procedures — dice, coin tosses, the <em>I Ching</em> — since the 1950s to
                    decide what came next. The software was a natural partner: it proposed positions no trained dancer
                    would think of, and he kept them.
                  </p>
                </>
              }
            >
              ...
              <p>Press play. Then roll the dice and watch it propose a phrase nobody choreographed.</p>
            </Lead>

            <div className="grid gap-6 lg:grid-cols-[1fr_0.6fr] lg:items-start">
              <ParamBadges set={CHIPSETS.lifeforms} mode={mode} />
              <Plate plate={PLATES.cunningham} className="lg:-mt-40" imgClassName="max-h-[260px]" />
            </div>
          ...
          {/* ---------------------- 2. LABANOTATION ---------------------- */}
          <TabsContent value="laban" className="space-y-8">
            <Lead
              ...
              info={
                <>
                  <p>
                    Rudolf Laban published this system as <em>Kinetographie Laban</em> in 1928. It is still the most
                    widely used dance notation, and full scores are held in archives so works can be restaged decades
                    later.
                  </p>
                  <p>
                    A real staff has more columns than the four here — for the supporting legs, the torso, the head — and
                    extra signs for the quality of a movement. What you see below is the core idea, simplified.
                  </p>
                </>
              }
            >
              <p>
                Read this one <strong>from the bottom up</strong>, like watching a lift climb a wall. Each column is a
                body part. Every symbol answers three questions at once: its <strong>shape</strong> says which way the
                limb points, the <strong>filling</strong> says how high, and its <strong>height on the page</strong> says
            ...
            <div className="grid gap-6 lg:grid-cols-[1fr_0.85fr] lg:items-start">
              ...
              <Plate plate={PLATES.labanDirections} className="lg:-mt-24" />
            </div>
          ...
          {/* ---------------------- 3. BENESH ---------------------- */}
          <TabsContent value="benesh" className="space-y-8">
            <Lead
              ...
              info={
                <>
                  ...
                  <p>
                    A full score also records travelling and turning under the stave, and reads in bars like music. Here
                    you see only the frames.
                  </p>
                </>
              }
            >
              ...
              <p>
                ...
                how deep: <span className="font-mono">|</span> in front, <span className="font-mono">—</span> level with
                the body, <span className="font-mono">•</span> behind. Each frame is one moment — a photograph, thirty
                years before keyframing had a name.
              </p>
            </Lead>

            <div className="grid gap-6 lg:grid-cols-[1fr_0.85fr] lg:items-start">
              <ParamBadges set={CHIPSETS.benesh} mode={mode} />
              <Plate plate={PLATES.benesh} className="lg:-mt-32" />
            </div>
          ...
          {/* ---------------------- 4. ESHKOL-WACHMAN ---------------------- */}
          <TabsContent value="ew" className="space-y-8">
            <Lead
              ...
              info={
                <>
                  <p>
                    Noa Eshkol, an Israeli choreographer, built this system in 1958 with the architect Avraham Wachman.
                    She wanted movement described without any reference to style, mood or stage.
                  </p>
                  <p>
                    Because it only describes angles, it has been used far beyond dance: for sign language, physical
                    therapy, and studies of animal behaviour.
                  </p>
                </>
              }
            >
              <p>
                ...
                is just two numbers: <strong>how high</strong> (0 is straight down, 4 is straight up) and{" "}
                <strong>which way round</strong> (one step = 45°, like an eighth of a turn).
              </p>
            ...
            <div className="grid gap-6 lg:grid-cols-[1fr_0.6fr] lg:items-start">
              ...
              <Plate plate={PLATES.eshkol} className="lg:-mt-40" imgClassName="max-h-[300px]" />
            </div>
          ...
          <TabsContent value="compare" className="space-y-8">
            <Lead eyebrow="Side by side" title="The same movement, four spellings">
              <p>
            ...
            <div className="grid gap-6 md:grid-cols-2">
              ...
              <div className="space-y-6">
                <Plate plate={PLATES.labanPortrait} imgClassName="max-h-[300px]" />
                <Card>
                  <CardContent className="prose-note space-y-3 text-[1.05rem]">
                    <p>
                      ...
                      — drives every rendering on this page. That structure is itself the answer to the question the page
                      asks: the abstracted parameter set, without a body.
                    </p>
                  </CardContent>
                </Card>
              </div>
      ...
      <footer className="bg-muted/40 border-t">
        <div className="mx-auto grid max-w-[1200px] gap-10 px-5 py-14 md:grid-cols-3">
          ...
          <div className="space-y-2">
            <h3 className="flex items-center gap-1 font-medium">
              ...
              <InfoTip title="What has been left out">
                ...
                <p>Real Eshkol-Wachman divides angles as finely as it likes, and distinguishes flat, cone-shaped and
                  twisting paths.</p>
              </InfoTip>
            </h3>
            <p className="prose-note text-[1rem]">
